...
struct Snake 
{
	int positionX{};
	int positionY{};
	int tailPositionX[1000]{};
	int tailPositionY[1000]{};
	int tailLenght{};
	bool isDead{};
};
struct Food 
...
void drawGame(Snake snake, Food snakeFood, int currentDirection,int lastDirection,int headColor,int bodyColor,int foodColor,int& animation);
